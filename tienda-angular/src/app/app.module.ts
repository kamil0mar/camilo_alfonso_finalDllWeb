...
import { AngularFireModule } from '@angular/fire'; //Inyectar los componentes de angularfire2
//======================Importar Servicios====================================
...
@NgModule({
  ...
  providers: [AuthService, TiendaService, CarritoService, AppComponent], //Inyectar los servicios TiendaDatabaseService y DatabaseService dentro de la aplicacion
